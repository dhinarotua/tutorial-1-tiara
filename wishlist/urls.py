...
from wishlist.views import add_wishlist_item
...
urlpatterns = [
    ...
    path('create-data', show_wishlist_ajax, name='show_wishlist_ajax'),
    ...
    path('create-data/submit', add_wishlist_item, name='add_wishlist_item'),
]